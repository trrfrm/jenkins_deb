...
resource "aws_route_table_association" "association" {
    ...
    route_table_id      = contains(local.public_subnets, lookup(aws_subnet.subnets[count.index].tags_all, "Name", "")) ? aws_route_table.public_rt.id: aws_route_table.private_rt.id
